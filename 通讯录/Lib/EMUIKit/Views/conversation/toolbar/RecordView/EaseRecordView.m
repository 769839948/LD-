...
+ (void)initialize
{
    ...
    recordView.upCancelText = @"Fingers up slide, cancel sending";//NSEaseLocalizedString(@"message.toolBar.record.upCancel", @"Fingers up slide, cancel sending");
    recordView.loosenCancelText = @"loosen the fingers, to cancel sending";//NSEaseLocalizedString(@"message.toolBar.record.loosenCancel", @"loosen the fingers, to cancel sending");
}
