        ...
        [_searchController setDidSelectRowAtIndexPathCompletion:^(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            if (indexPath.section == 0) {
                ...
                dispatch_block_t block = ^{ @autoreleasepool {
                    ...
                    NSArray *results = [weakSelf.conversation loadMoreMessagesContain:weakSelf.searchBar.text before:message.timestamp limit:SEARCHMESSAGE_PAGE_SIZE];
//                    NSArray *results = [weakSelf.conversation loadMoreMessagesContain:weakSelf.searchBar.text before:message.timestamp limit:SEARCHMESSAGE_PAGE_SIZE from:weakSelf.textField.text];
//
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText
{
    ...
    dispatch_block_t block = ^{ @autoreleasepool {
        NSArray *results = [weakSelf.conversation loadMoreMessagesContain:searchBar.text before:[self.datePicker.date timeIntervalSince1970]*1000 limit:SEARCHMESSAGE_PAGE_SIZE];
